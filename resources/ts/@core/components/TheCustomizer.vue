      ...
      <PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
        ...
        <CustomizerSection title="THEMING" :divider="false">
          ...
          <VRadioGroup v-model="theme" inline>
            <VRadio v-for="themeOption in ['system', 'light', 'dark']" :key="themeOption" :label="themeOption"
              :value="themeOption" class="text-capitalize" />
          </VRadioGroup>
        ...
        <CustomizerSection title="MENU">
          ...
          <VRadioGroup v-model="appContentLayoutNav" inline>
            <VRadio v-for="[key, val] in Object.entries(AppContentLayoutNav)" :key="key" :label="key" :value="val" />
          </VRadioGroup>
